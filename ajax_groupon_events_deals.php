...
$dropCity = $_POST['formatted'];
		...
		$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".rawurlencode($dropCity)."&lat=".$latitude."&lng=".$longitude."&query=".rawurlencode($dropCity)."+events+deals&division=".rawurlencode($dropCity)."&offset=0&limit=5&locale=en_US";
