				...
				var app = new Vue({
					...
					methods:{
						getSpecificData: function(){
							var vm = this;
							vm.ajaxRequest = true;
							vm.checkSessionServer =  axios.post('<?php echo $SiteURL; ?>ajax_specific_flight-dev.php', {source: vm.source,info: vm.info, geodemo: vm.geodemo,formatted: vm.formatted,title: vm.title, key: vm.key });
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-4">
						<div class="footer-logo">
							<img src="https://mysittivacations.com/images/logo-footer.png">
						</div>
					</div>
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="mailer-sec">
							<img src="https://mysittivacations.com/images/mailnew.png">
