...
.photo_slider .bx-wrapper li a { 
  min-height: 203px !important; 
  background:transparent none !important;
  border:0 !important;
}
 .photo_slider .bx-wrapper li a img {
...
?>
	<!-- END SIDEBAR CODE -->
		<article class="forum_content v2_contentbar">
			<div class="v2_rotate_neg">
				...
				<?php 
  				...
  				?>		<div class="band_event">
							<div class="icn_band_event"> 
								<img src="images/icon_band_event.png" alt=""> 
							</div>
				...
				?>
					  	<div class="special_band">
							...
							<?php 
									...
									?>
							<div class="thumb_profile specialz">
							  <?php 
			...
			<?php 		} // END COUNT SPECIAL CONDITION	?>
