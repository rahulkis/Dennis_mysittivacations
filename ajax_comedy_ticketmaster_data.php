...
if (isset($page)) :
	...
	$urlgo = "https://app.ticketmaster.com/discovery/v2/events?apikey=RfcE2uw4xpNzXAWjzvXzA5xxiKuuU9G4&keyword=comedy&sort=date,asc&countryCode=US&city=".$city."&page=0";
endif;
