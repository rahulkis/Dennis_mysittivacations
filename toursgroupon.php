...
$location = rawurlencode($_POST['formatted']);
...
$longitude = $output->results[0]->geometry->location->lng;
	...
	{
		$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".$location."&lat=".$latitude."&lng=".$longitude."&query=Tour&division=".$location."&locale=en_US&limit=10&campaign.currency=USD";
        ...
        $html = "";
       echo  $html1 .= "<h2 class='near_events_first'> ".$_POST['formatted']." Tour</h2>";
       echo $html2 .= "<article style='width: 100% !important; padding: 4px !important;' >";
