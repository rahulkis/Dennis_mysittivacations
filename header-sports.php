...
<!-- <link defer href="/css/custom.css?ver=2" rel="stylesheet" /> -->
...
.content-banner .geo.geocontrast {
    margin: 4px auto;
}
...
.banner-section.hotel-hero .carousel-caption-top h1{color: #fff;font-size: 24px;text-align: center;}
...
.search-content.hotels ul li .form-group{display: block}
            ...
            <div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a href="#" class="nav-link contact-button btn_login">Contact Us</a></li>
                    </ul>
                </div>
            </div>
        </nav>
