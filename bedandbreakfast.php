	...
	<div class="v2_content_inner_topslider spacer1">
		...
		<div class="planTap" style="margin-top: 20px;">Plan a Vacation. Plan a Night Out. <br>
			...
			<aside class="sidebar v2_sidebar">
				<div class="hotel-side">
					 ...
					 <div data-role="page">
					    ...
					    <div class="cj_banner">
					    	<script type="text/javascript" language="javascript" src="http://www.jdoqocy.com/placeholder-29373269?target=_top&mouseover=N"></script>
					    </div>
					    <div class="cj_banner">
			...
			<?php
				...
				$file = "https://mysittidev.com/cj/BedandBreakfast_com-Product_Catalog.xml";
				...
				?>
					<div class="hotel_list">
						...
						<div class="hotel_data">
							<h2><a href="<?php echo $deal['buyurl']; ?>" target="_blank"><?php echo $deal['keywords']; ?></a></h2>
							<h4 class="city_nme"><?php echo $deal['name']; ?></h4>
							
							<div class="evnt_nme">
								<h3 class="sports_name"><?php echo $deal['description']; ?></h3>
							</div>
						...
						<div class="hotel_check">
							<!-- <li>
								<a href="#">www.BedandBreakfast.com</a>
								</br>
								<span>$<?php echo $deal['Price']; ?></span>
							</li> -->
							<li><a href="<?php echo $deal['buyurl']; ?>" class="hotelLink" target="_blank">Get Deals</a></li>
