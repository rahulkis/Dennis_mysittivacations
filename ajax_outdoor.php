...
$post_limit = 30;
	...
	{
		$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".$location."&query=sports+outdoors&division=".$location."&locale=en_US&limit=".$post_limit." ";
