...
<link href="<?php echo $SiteURL; ?>css/bootstrap.min.css" rel="stylesheet"  type="text/css">
          <section>
           ...
           <div class="container Preception">
              <!-- <div class="text-center">
                <h2>Choose EPK Template</h2>
                <a style="float:right" class="learnEpk" href="<?php echo $SiteURL; ?>Epk_kit.php">
                Learn More
              </a>
              </div> -->

              <div class="atrlHeading">
              <h2 class="atrlDeal">Choose EPK Template</h2>
              <span class="atrlView"><a href="#">Learn More</a></span>
            </div>
              <div class="col-sm-4">
               <h3>Template 1</h3>
               <a id="fancybox_img" href="template1"><img src="images/template1.png" width="350" height="300"></a>
              </div>
              <div class="col-sm-4">
                <h3>Template 2</h3>
                <a id="fancybox_img" href="template2"><img src="images/template2.png" width="350" height="300"></a>
              </div>
              <div class="col-sm-4">
                <h3>Template 3</h3>
                <a id="fancybox_img" href="template3"><img src="images/template1.png" width="350" height="300"></a>
              </div>
