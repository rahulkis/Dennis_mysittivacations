...
if($userArray[0]['type_of_club'] == "97")
{
	$uu = 'dj_home.php';
	$Obj->Redirect($uu);
	die();
}
elseif($userArray[0]['type_of_club'] == '101')
{
	$Obj->Redirect("band_home.php");
	die();
}
elseif($userArray[0]['type_of_club'] == '102')
{
	$Obj->Redirect("theatre_home.php");
	die();
}
elseif($userArray[0]['type_of_club'] == '103')
{
	$Obj->Redirect("fight_home.php");
	die();
}
elseif($userArray[0]['type_of_club'] == '96')
{
...
<div class="v2_container">
	<div class="v2_inner_main v2_gutter50">
	<!-- SIDEBAR CODE  -->
	...
	<!-- END SIDEBAR CODE -->
		...
		<?php
					...
					?>
							...
							<div class='upcoming upcoming_events1 head_ev' style="border-bottom: none;">
			...
			<?php		} // END COUNT EVENTS		?>
				</div>
			
			<div class="home_content_bottom">
    <div class="seprators"></div>
				<div class="photo_slider fighter_photos">
					<h2>Photos</h2>
					<?php 
     ...
     <div class="seprators"></div>
				<div class="video photo_slider" style="display:none;">
					<h2>Videos</h2>
					...
					if(mysql_num_rows($video_Array)>0) {
						...
						<li id="jw_<?php echo $video_row['video_id'];?>"> 
							<a  id="ve_<?php echo $video_row["video_id"];?>" href="#dialogx<?php echo $video_row["video_id"];?>" name="modal"> </a>
						...
						<?}
						 ...
						 {
							//echo "<div class='nophotos'><h2>No Videos Yet!</h2></div>";
						 }
					...
					<div class="hostadd">
						...
						<ul>
							...
							<?php 	}
								...
								{
							?>
							<a onmouseover="jwplayer('add<?php echo $res["id"];?>').play();" onmouseout="jwplayer('add<?php echo $res["id"];?>').pause();" id="ve_<?php echo $res["id"];?>" href="#dialogx<?php echo $res["id"];?>" name="modal"> </a>
							...
							{
								//echo "<li><h3> No Ads Uploaded yet! </h3></li>";
							}
							 ?>
							<?php 
							if($res['adv_link'] != "")
