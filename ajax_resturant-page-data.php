...
$dropCity = $_POST['changeValue'];

$category_data = 'restaurant+deals';
    ...
    $ch = curl_init();   
	$urlgo = "https://api.yelp.com/v3/businesses/search?term=".$category_data."&latitude=".$latitude."&longitude=".$longitude."";
