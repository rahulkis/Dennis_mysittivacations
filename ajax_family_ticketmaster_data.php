...
if (isset($page)) :
	$urlgo = "https://app.ticketmaster.com/discovery/v2/events?apikey=RfcE2uw4xpNzXAWjzvXzA5xxiKuuU9G4&keyword=family&sort=date,asc&countryCode=US&city=".$city."&page=".$page."";
else:
	$urlgo = "https://app.ticketmaster.com/discovery/v2/events?apikey=RfcE2uw4xpNzXAWjzvXzA5xxiKuuU9G4&keyword=family&sort=date,asc&countryCode=US&city=".$city."&page=0";
endif;
