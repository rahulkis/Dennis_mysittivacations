		...
		<article class="forum_content v2_contentbar newSectionEvents">
			...
			<div class="Listed_Categories">
				<div class="TonightArtistListing">
					<h2> 
						<img src="images/artist.png" alt="">All <?php echo $catNameUrl; ?> Artist
					</h2>
				</div>
				...
				AND `club_city` = '$_SESSION[id]' ORDER BY `profile_count` DESC");
					...
					while($rest3 = mysql_fetch_assoc($getAllArtists))
					{
						...
						?>
    						<li>
								<span class="city_users"><?php echo $city_name;?>, <?php echo $satacode;?></span> 
								<!-- <span class="state_users"></span>  -->
