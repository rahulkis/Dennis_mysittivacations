...
<div data-aos="zoom-in-right" class="banner-section hotel-hero comedy-sec" style="background-image:url(images/Performing_Arts.jpg)"> 
	<div class="container">
		<div class="mobile-hero">
			<img src="images/Performing_Arts.jpg">
		</div>
		<div class="carousel-caption-top">
		   <h1>Creativity, Expression, And Inspiration in  <?php echo $_SESSION['city_name']; ?></h1>
		</div>
...
<div class="rind-the-right-section comedy-sec">
		<div class="container n-contain ">
					...
					<div class="sidebar-listing">
						...
						<div class="specialities-checkbox">
							<div class="searcher-sec">
								...
								<div class="form-group">
									<input type="text" class="form-control" id="refine-result" value="<?php echo $_SESSION['city_name']; ?>" placeholder="New York NY, USA">
								</div>
							</div>
						</div>
						...
						<div class="modal fade" id="filter-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								...
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck01" value="Arts and Theater">
								  <label class="custom-control-label" for="customCheck01">Arts and Theater</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck02" value="Broadway">
								  <label class="custom-control-label" for="customCheck02">Broadway</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck03" value="Off-Broadway">
								  <label class="custom-control-label" for="customCheck03">Off-Broadway</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck04" value="Ballet and Dance">
								  <label class="custom-control-label" for="customCheck04">Ballet and Dance</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck05" value="Classical">
								  <label class="custom-control-label" for="customCheck05">Classical</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck06" value="Comedy">
								  <label class="custom-control-label" for="customCheck06">Comedy</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck07" value="Film Festivals">
								  <label class="custom-control-label" for="customCheck07">Film Festivals</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck08" value="Museums and Exhibits">
								  <label class="custom-control-label" for="customCheck08">Museums and Exhibits</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck09" value="Music" checked="">
								  <label class="custom-control-label" for="customCheck09">Musicals</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck10" value="Opera">
								  <label class="custom-control-label" for="customCheck10">Opera</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck11" value="Plays">
								  <label class="custom-control-label" for="customCheck11">Plays</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="More Arts and Theater">
						...
						<div class="specialities-checkbox new_for_mb">
							<div class="listing-check">
								<h4>CATEGORY</h4>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck01" value="Arts and Theater">
						...
						<div class="adver-comedy">
							...
							<img src="https://www.lduhtrp.net/image-8265264-13165240" width="200" height="600" alt="" border="0"/></a>
					
						    <!-- <img src="./img/ss/addimg2.png" class="img-fluid w-100"> -->
							<a href="https://www.tkqlhce.com/click-8265264-10417493" target="_top">
							<img src="https://www.tqlkg.com/image-8265264-10417493" width="300" height="250" alt="" border="0"/></a>
						...
						<div class="row">
							<div class="col-md-12 col-12">
								<div class="heading-content">
									...
									<h4>Groupon Performing Comedy Concert Deals</h4>
									</div>
								</div>
							</div>
			...
			if(!empty($city)):
				...
				$urlgo ="https://www.groupon.com/occasion/deals-json?filterQuery=(deal_type:groupon-deals-4269)%20AND%20(subcategory2:".$key.")&context=web_holiday&showBestOption=true&divisionLoc=".$latitude.",".$longitude."&divisionLocale=en_US&pageType=holiday&apiFacets=topcategory%7Ccategory%7Ccategory2%7Ccategory3%2Cdeal_type&sort=price:desc&includeHtml=true&offset=0&limit=20";
			else:

				if(!empty($key)):
					$urlgo = "https://www.groupon.com/occasion/deals-json?filterQuery=(subcategory2:".$key.")&context=web_holiday&showBestOption=true&divisionLoc=".$latitude.",".$longitude."&divisionLocale=en_US&pageType=holiday&apiFacets=topcategory%7Ccategory%7Ccategory2%7Ccategory3%2Cdeal_type&sort=price:desc&includeHtml=true&offset=0&limit=20";
				else:
			...
			return $get_deals;
									   ...
									   $get_deals = groupon_api_call('40','','theater-and-shows');
										if(!empty($get_deals)){ ?>
									...
									<div class="testimonial-section products">
									   ...
									   <?php $getyelpTourData = yelp_api_call(20,$_SESSION['city_name'],'Arts and Theater'); 
									...
									<?php $dropCity = $_SESSION['city_name'];
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(document.body).on('click','.next-refine',function(e){
				...
				$.ajax({
					url: "ajax_refine_ticketmaster_next_data_performe_dev.php",
					type: "POST",
					data: {
			...
			$(document.body).on('click','.prev-refine',function(e){
				...
				$.ajax({
					url: "ajax_refine_ticketmaster_ajax_refine_ticketmaster_next_data_performe_dev.phpnext_data.php",
					type: "POST",
					data: {
						formatted: geodemo, page : key, dropValue : value
					},
...
<style>
	...
	@media screen and (max-width:767px){
		...
		.specialities-checkbox.new_for_mb{
			display: none;
		}
