...
$dropCity = $_POST['formatted'];
 ...
 if (!empty($_POST['search_slug'])) {
 	...
 	$search_slug = 'restaurants';
		...
		$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".rawurlencode($dropCity)."&lat=".$latitude."&lng=".$longitude."&query=".rawurlencode($dropCity)."+".rawurlencode($search_slug)."&division=".rawurlencode($dropCity)."&filters=category:food-and-drink&offset=0&limit=5&locale=en_US";
