...
<div data-aos="zoom-in-right" class="banner-section hotel-hero comedy-sec" style="background-image:url(images/imgpsh.jpg)"> 
	<div class="container">
		<div class="mobile-hero">
			<img src="images/imgpsh.jpg">
		</div>
					...
					<div class="sidebar-listing">
						...
						<div class="modal fade" id="filter-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								...
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" id="customCheck04" name ="dropDownId" value="blues" checked="">
						...
						<div class="row">
							<div class="col-md-12 col-12">
								<div class="heading-content">
									...
									<h4>Groupon Performing Blue Music</h4>
									</div>
								</div>
							</div>
