...
$limit = 30;
	...
	<?php
		...
		$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&query=".$value."&division_id=".$cityvalue."&lat=".$latitude."&lng=".$longitude."&offset=0&limit=50";
