...
<h1 class="h1">See all list of <a href="<?php echo $SiteURL;?>listevent.php?host_id=<?php echo $_GET['host_id'];?>">Upcoming Events</a></h1>
			<?php 
...
<div class="video fighter_pro_special">
  <?php 
 ...
 <ul class="photoslider2">  
      ...
      <span class="redeemedpass">REDEEMED</span> </li>
      <?php 									}
													else
													{ 
					?>
      <li> <a href="<?php echo $imgsrc ?>" rel="group" class="fancybox"><img style="width: 50px;" src="<?php echo $thumb ;?>" alt="" /></a>
       <span class="downloadedpass">DOWNLOADED</span> </li>
      <?php 											}
												}
												else
												{
					?>
      <li> <a href="<?php echo $imgsrc ?>" rel="group" class="fancybox"><img style="width: 50px;" src="<?php echo $thumb ;?>" alt="" /></a> 
      <span class="passdownload" onclick="download_host_pas('<?php echo $hostID; ?>', '<?php echo $_SESSION['user_id']; ?>', '<?php echo $row['id']; ?>');">DOWNLOAD PASS</span> </li>
      <?php 
												}
											}
										}
...
<?php 			}
			...
			if(@mysql_num_rows($video_Array)>0) 
			{
				?>
      <div class="seprators"></div>
<div class="video photo_slider fighter_pro_video band_video">
