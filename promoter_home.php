    ...
    <div class="seprators"></div>
							<div class="video tonighListing">
								...
								<div class="SponsorsListing">
									...
									{
									?>
										<div class="Sponsors_box promotorHome">

										<?php 
											if( !empty( $featuredProduct['video'] ) )
											{
												$Videopath = str_replace("../", "", $featuredProduct['video']);
										?>
												<div class="product_box-img product_sponsors" id="sponsorvideo_<?php echo $featuredProduct['id']?>">

												</div>
												<script type="text/javascript">
													jwplayer("sponsorvideo_<?php echo $featuredProduct['id']; ?>").setup({
