<!doctype html>
    ...
    <head>
       ...
       <!--  <meta name="google-site-verification" content="g7Wlxf6fv_3B4dAY80nr2UDbfMpWBb14xf9qkKbPLmY" /> -->
        ...
        <link async href="https://develoment.mysittivacations.com/css/homePage.css" rel="stylesheet" type="text/css" async>
        <!--fontawesome CSS-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="container">
                <a class="navbar-brand" href="https://www.mysittivacations.com/">
                    <img src="img/logo.png" class="logo" alt="image" loading="lazy">
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExample04">
                    <ul class="navbar-nav">
                       <!--  <li class="nav-item"><a href="#"><img src="img/plus_icon.png">Post</a></li> -->
                       <!--  <li class="nav-item"><a href="#"><img src="img/alert_cion.png">Alerts</a></li> -->
                        <li class="nav-item active"><a href="trips.php"> <img src="img/map_icon.png">Trips</a></li>
                        <li class="nav-item"><a href="#"  data-toggle="modal" data-target="#subscribe" data-afflication="" data-page="index" data-info="" data-table="subscribe" data-title="Subscribe" class="open-subscribe btn_login px-4" class="btn_login">Sign up</a></li>
        ...
        <script>
            $(document).ready(function(){
                $('#mc-embedded-subscribe').click(function(){
                    setTimeout(function(){ swal("Thanks for the subscribe"); window.location.replace("https://develoment.mysittivacations.com/"); }, 2000);
                })
            })
        </script>
        <script>
