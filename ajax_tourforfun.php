 ...
 if($_SESSION['city_name'] == 'Washington D.C.'){
 	...
 	$randon_deals = "SELECT * FROM  tours4fun_xml_listing WHERE city LIKE '%".$_POST['city_name']."%' AND tag = 'Tours4Fun'  LIMIT $limit";
 }
 ...
 <?php if($count > 0){?>
 	<div class="text-center">
 		<div class="tour_load_more" style="text-align: center;color: black;" data-limit ="<?php echo $limit; ?>">Load more</div>
 	</div>
 <?php }
 ?>
