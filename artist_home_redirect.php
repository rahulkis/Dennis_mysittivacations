...
<!-- <div class="club_banner bannermain_dj" <?php if($countBanner != 0) { ?> style="background:url('host_banner/<?php echo $banner; ?>') no-repeat  center top  rgba(0, 0, 0, 0) !important; background-size: 100% auto !important;" <?php } ?>>
  <?php if($_SESSION['user_type'] == "club" && !isset($hostID)) {?>
...
<div class="v2_container">
	<div class="v2_inner_main mtop30">
	<!-- SIDEBAR CODE  -->
							...
							<div class="photo_band_slider photo_slider">
							  <ul class="videoslider1  slide_new_band">
								<?php
													...
													{
													?>
								<li id="jw_<?php echo $video_row['video_id'];?>" class="child_vid"> <a class=""  id="ve_<?php echo $video_row["video_id"];?>" href="#dialogx<?php echo $video_row["video_id"];?>" name="modal"></a>
							  ...
							  <table class="tonightmusictab responsivetable" id="hometonightlisting" style="background:none;">
								...
								<tr>
								  <td><audio style="display:none;" controls id="player<?php echo $a ;?>">
									...
									<a href='javascript:play1();' id="<?php echo $a;?>" class="test audio"><img height="30px" src="images/new_portal/play.png"></a> <a href='javascript:pause();' class='pause' id="<?php echo $a;?>"><img height="30px" src="images/new_portal/pause.png"></a></td>
