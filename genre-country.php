...
<div data-aos="zoom-in-right" class="banner-section hotel-hero comedy-sec" style="background-image:url(images/country-music.jpg)"> 
	<div class="container">
		<div class="mobile-hero">
			<img src="images/country-music.jpg">
		</div>
					...
					<div class="sidebar-listing">
						...
						<div class="modal fade" id="filter-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								...
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" id="customCheck08" name ="dropDownId" value="country" checked="">
						...
						<div class="row">
							<div class="col-md-12 col-12">
								<div class="heading-content">
									...
									<h4>Groupon Performing Country Music</h4>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-12">
								<section class="client-sec comedy">
									<div class="testimonial-section products">
									   ...
									   <?php
									   $get_deals = groupon_api_call('20','','other-music');
									   if(!empty($get_deals)){ ?>
	...
	<script type="text/javascript">
		...
		$(document).on('click','.activity',function(){
			...
			$.ajax({
				...
				type: "POST",
				data: {
					formatted: textBox_city, srartdate: date1, enddate : date2, key : drop_down_keyword
				},
				beforeSend: function()
				{
					$("#loader").addClass("loading");
