...
div#powered_by_3873 {
    background-image: url(https://mysittivacations.com/images/rens.jpg);
...
<div class="v2_content_wrapper">
	<div class="v2_content_inner_topslider spacer1">
		...
		<div class="container ko">	
			<p class="jki" style="color: black; display: none; font-weight: 500;">Powered By:<img src="<?php echo $SiteURL; ?>images/Hotwire_logo.png"></p>
		</div>
...
<img src="https://www.awltovhc.com/image-8265264-13799498" width="728" height="90" alt="" border="0"/></a> -->
		...
		<article id="atrl" class="oneArticle secondAtlcle">
		  	<div class="row road-trip">
				<!-- <p style="color: black;" class="hjg">Powered By:<img src="https://mysitti.com/images/Hotwire_logo.png"></p> -->
		    <div class="col-sm-6">
		      <p class='rent-with'>Rent With Companies You Know and Trust</p>
		    </div>
		    <div class="col-sm-6">
		      <img src="/images/cheap-car-rentals-san-diego.png" class="img-responsive">
		    </div>
		  </div>

		  <div class="row">
		    <div class="col-sm-12 rent-logo">
		      <ul>
		      	<li><img src="/images/car-rent-logo/Reviewenterpriz1.png"></li>
		      	<li><img src="/images/car-rent-logo/2000px-Hertz_Logo.png"></li>
		      	<li><img src="/images/car-rent-logo/Alamo_Rent_a_Car_(logo).png"></li>
		      	<li><img src="/images/car-rent-logo/dollar-rent-a-car-logo.png"></li>
		      	<li><img src="/images/car-rent-logo/MM55552LOGO-c.png"></li>
		      	<li><img src="/images/car-rent-logo/Thrifty_Car_Rental_logo_logotype.png"></li>
		      </ul>
		    </div>
		  </div>

		  <div class="row">
		    <div class="col-sm-12 rent-flifgt-deals">
		    <h2>Flights Deals<span style="color: black; font-weight: 500; float: right;font-size: 14px;">Powered By: Travelpayouts</span></h2>
		    <ul class="popular__list carRentelWidgrt">
      		<li><script async src="//www.travelpayouts.com/weedle/widget.js?marker=130544&host=flights.mysittivacations.com%2Fflights&locale=en&currency=usd&powered_by=false&destination=LON&destination_name=London" charset="UTF-8"></script></li>
      		<li>
      			<script async src="//www.travelpayouts.com/weedle/widget.js?marker=130544&host=flights.mysittivacations.com%2Fflights&locale=en&currency=usd&powered_by=false&destination=BKK&destination_name=Bangkok" charset="UTF-8"></script></li>
      		<li>
      			 <script async src="//www.travelpayouts.com/weedle/widget.js?marker=130544&host=flights.mysittivacations.com%2Fflights&locale=en&currency=usd&powered_by=false&destination=PAR&destination_name=Paris" charset="UTF-8"></script></li>
      		<!-- <li>
      			<script async src="//www.travelpayouts.com/weedle/widget.js?marker=130544&host=flights.mysittivacations.com%2Fflights&locale=en&currency=usd&powered_by=false&destination=DXB&destination_name=Dubai" charset="UTF-8"></script></li>
      		<li>
      			<script async src="//www.travelpayouts.com/weedle/widget.js?marker=130544&host=flights.mysittivacations.com%2Fflights&locale=en&currency=usd&powered_by=false&destination=SIN&destination_name=Singapore" charset="UTF-8"></script></li>
      		<li>
      			<script async src="//www.travelpayouts.com/weedle/widget.js?marker=130544&host=flights.mysittivacations.com%2Fflights&locale=en&currency=usd&powered_by=false&destination=KUL&destination_name=Kuala%20Lumpur" charset="UTF-8"></script></li> -->
      		</ul>	
...
<?php
include('landingPage-footer.php'); 
