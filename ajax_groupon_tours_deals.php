...
$geocode=file_get_contents('https://maps.google.com/maps/api/geocode/json?address='.$prepAddr.'&sensor=false&key=AIzaSyDvcXMGhJrh_bMGNoygumOIt49uAOIKSdQ');
echo $geocode;
...
if(empty($latitude) && empty($longitude)):
	...
	$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".rawurlencode($dropCity)."&lat=".$latitude."&lng=".$longitude."&query=".rawurlencode($dropCity)."+tours&division=".rawurlencode($dropCity)."&offset=0&limit=5&locale=en_US";
else:
	$urlgo ="https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_201236_212556_0&query=tours&lat=".$latitude."&lng=".$longitude."&offset=0&limit=5";
endif;
