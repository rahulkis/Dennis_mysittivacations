		...
		var app = new Vue({
			...
			methods:{
				getSpecificData: function(){
					var vm = this;
					vm.ajaxRequest = true;
					vm.checkSessionServer =  axios.post('<?php echo $SiteURL; ?>ajax_specific_home.php', {source: vm.source,info: vm.info, geodemo: vm.geodemo,formatted: vm.formatted,title: vm.title, key: vm.key });
...
<div class='modal fade' id='more_audio_tour'  tabindex="-1" data-focus-on="input:first"  role='dialog'>
	<div class='modal-dialog'>
		<div class='modal-content py-0'>
			...
			<div class="audio_tour_modal p-3">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5">
				...
				<p class="footer_pra">We can help you find the perfect trip and see how to plan a vacation. Our travel website makes it easy to find the perfect trip and book one today! Check out our deals on flights, hotels, cruises, adventure tours, car rentals, tours, and more. Plus, check out our top-rated hotels, restaurants, shopping, and entertainment in over 250 locations worldwide. With so much to see and do, you want to make sure that you've got the best travel plans. That's why we created our site: to help you find a great vacation package that you can't find anywhere else.</p>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<ul class="menu">
							...
							<!-- <li><a href="tel:000-900-9090"><i class="fas fa-phone me-3"></i>000-900-9090</a></li> -->
						</ul>
					</div>
				</div>
			</div>
