...
// 	$ID = mysql_insert_id();
// 	mysql_query("INSERT INTO chat_users_groups (group_id,user_id,user_type,loggedin) VALUES ('$ID','$clubId','club','1')");
// }
            ...
            <div class="upcoming upcoming_clubs">
              ...
              <div id="liveonHost" class="livehost_btn" style="display:none;">
                <?php 
					//$pieces = explode(" ", $profilename);
		  //$username_dash_separated = implode("-", $pieces);
		  $username_dash_separated = clean($n);
                ...
                <ul class="djListings">
                  ...
                  <li> <span class="subuserinfo">
                    ...
                    <div class="subusercam">
                      <p> <a href='music_request.php?host_id=<?php echo $fetcharray['id'];?>'><?php echo $profilename."-".$fetcsubuserquery['username']; ?></a> </p>
                      <br>
                      <?php
...
if($mobile === true) { 
?>
                      <p> <a class="button" name="submit"  onclick="goto1('https://192.163.248.47:1935/live/<?php echo $Subusername_dash_separated; ?>/playlist.m3u8')">Live Streaming
            ...
            <div class="bookingsType">
              ...
              <div class="Listings">
                <ul>
                  <li>
                    <div class="innerItem">
                      <div class="thumbTick"> <a rel="group" href="https://mysitti.com/bookingsTypeDetails.php?typeID=17&amp;host_id=497799"> <img alt="" src="upload/_7bcd90c612d057363c430b259edec2a3_thumnail_94757823_scaled_338x254.jpg"> </a> </div>
                      <div class="titleTick"> Weddings </div>
                      <div> <a class="bookTick" href="#" > Book </a> </div>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div class="hotpass_dj">
                ...
                <div class="thumb_profile photo_slider">
									...
									if($get_difference >= 0)
									{
										if(isset($_GET['host_id']) && $_SESSION['user_type'] == 'user')
										{
											...
											if($count_p == 1)
											{
												...
												{ 
									?>
                  <li> <a href="<?php echo $imgsrc ?>" rel="group" class="fancybox"><img src="<?php echo $thumb ;?>" alt="" /></a> <span class="redeemedpass">REDEEMED</span>
                    <div class="clear"></div>
                    <div class="clear"></div>
                  ...
                  <?php               }
												...
												{ 
									?>
                  <li> <a href="<?php echo $imgsrc ?>" rel="group" class="fancybox"><img src="<?php echo $thumb ;?>" alt="" /></a> <span class="downloadedpass">DOWNLOADED</span>
                    <div class="clear"></div>
                    <h5><?php echo $rowCoupon['coupon_name'];?></h5>
                  </li>
                  <?php               }
											...
											{
								?>
                  <li> <a href="<?php echo $imgsrc ?>" rel="group" class="fancybox"><img src="<?php echo $thumb ;?>" alt="" /></a> <span class="passdownload" onclick="download_host_pas('<?php echo $hostID; ?>', '<?php echo $_SESSION['user_id']; ?>', '<?php echo $rowCoupon['id']; ?>');">DOWNLOAD PASS</span>
                    <div class="clear"></div>
                    <h5><?php echo $rowCoupon['coupon_name'];?></h5>
                  </li>
                  <?php 
            ...
            <div class="dj_right djevents">
              <div class=" ">
				...
				?>
                <h1 class="h1">See all list of <a href="<?php echo $linkEvents; ?>">Upcoming 
                ...
                <div class="event_list_container">
                  <div class="NewBand">
                    ...
                    <li>
                      <div class="v2_thumb_event">
                        <div class=" ">
                          <?php 
														...
														{
													?>
                          <a rel="group" class="fancybox" href="<?php echo str_replace('../', '', $row['event_image']); ?>"> <img alt="" src="<?php echo str_replace('../', '', $row['event_image_thumb']); ?>"> </a>
                          <?php   	}
														else
														{
												?>
                          <a rel="group" class="fancybox" href="<?php echo $SiteURL.'events_icons/'.$row['event_category'].'.jpg'; ?>"> <img alt="" src="<?php echo $SiteURL.'events_icons/'.$row['event_category'].'.jpg'; ?>"> </a>
                          <?php
														}
											 	?>
                        </div>
                      ...
                      <div class="BuyMore rmore"> <a onclick="javascript:void window.open('read_more_cityevent.php?id=<?php echo $row['id'] ?>&action=event','','width=500,height=700,resizable=true,left=0,top=0');return false;"> <img src="images/rmore.png" alt="More" /> </a> </div>
                      <div class="BuyMore BuyMoreTickets">
                        ...
                        <?php
													if($countPaidpasses > 0 && $fetchRecords['pass_status'] == "active" && ( $expiryPass > $currDate) )
													{
														...
														?>
                        <a  class="buyshowtickets"  href="buyStageTicket.php?host_id=<?php echo $HostID.'&str_amt='.$payment_amount.'&user_type='.$_SESSION['user_type'].'&passid='.$fetchRecords['pass_id'].'&event_id='.$row['id']; ?>"> Show Ticket </a>
                        <?php
													...
													if($count_ticket_check == 1 && $_SESSION['user_type'] == 'user')
													{
														...
														{ 
													?>
                        <a class="buysttickets" href="OneTimePay.php?pay=b4da7e5003f85ef0055f8fb026d9354e&host_id=<?php echo $_GET['host_id']; ?>&user_type=club&ticket_id=<?php echo $ticket_id; ?>&event_id=<?php echo $row['id']; ?>"> Streaming Ticket </a>
                        <?php
														}
														else
														{ ?>
                ...
                <table class="tonightmusictab responsivetable" id="hometonightlisting" style="background:none;">
                  ...
                  <tr>
                    <td><audio style="display:none;" controls id="player<?php echo $a ;?>">
                      ...
                      <a href='javascript:play1();' id="<?php echo $a;?>" class="test audio mynewclass_play_<?php echo $a; ?>"><img height="30px" src="images/new_portal/play.png"></a> <a href='javascript:pause();' style="display: none;" class='pause mynewclass_pause_<?php echo $a; ?>' id="<?php echo $a;?>"><img height="30px" src="images/new_portal/pause.png"></a></td>
