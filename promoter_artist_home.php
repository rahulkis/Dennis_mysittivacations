...
<div class="v2_container">
	...
	<article class="forum_content v2_contentbar">
		...
		?>
				...
				<div class="pass_fight artist_pass">
					<h1 class="h1">
						<img src="images/icon_hotpass_band.png" align="">Passes
					</h1>
					<?php 
		  ...
		  <?php			}	?>
			  ...
			  <?php
				...
				{
					?>
				<div class="special_fight artist_special">
					<h1 class="h1">
			...
			<?php 
						...
						?>
			  					<li>
			  						<a href="<?php echo $specailsImage;  ?>" rel="group" class="fancybox">
...
//$('#slider').nivoSlider();
 ...
 <div class="seprators"></div>
			<div class="comedy_listing_box">
				<div class="event_icon_fight"> 
					<img src="images/icon_video_band.png" align="">
				</div>
				<div class="events_listing_fight video_fights">
					<h1 class="h1">Videos</h1>
					<div class="comedy_slider_photo com_vid photo_slider artistvideo">
			...
			?>
								<li id="jw_<?php echo $video_row['video_id'];?>"> 
									...
									<input class="insideJwplayer" value="<?php echo $video_row["video_id"];?>" type="hidden" />
									<a  class=""  id="ve_<?php echo $video_row["video_id"];?>" href="#dialogx<?php echo $video_row["video_id"];?>" name="modal">
									</a>
...
<script type="text/javascript">
	$(document).ready(function(){
		// $('.artistvideo ul li').hover(
		// 	function () 
		// 	{
		// 		var id = $(this).find('.insideJwplayer').val();
		// 		jwplayer('a'+id).play();
		// 	}, 
		// 	function () 
		// 	{
								...
								<div class="SponsorsListing">
									...
									?>
										<div class="Sponsors_box">
											...
											<?php 
												if(empty($featuredProduct['video']))
												{ 
											?>
													<a href="<?php echo $featuredProduct['image_nm'];?>" rel="group" class="fancybox" >
											...
											?>
													...
													<div id="a<?php echo $featuredProduct['id']; ?>_wrapper" style="float:left; width:100% !important;"></div>
													<script type="text/javascript">
														jwplayer("a<?php echo $featuredProduct['id']; ?>_wrapper").setup({
															file: "<?php echo $featuredProduct['video']; ?>",
															height : 200 ,
															//width: 200
														});
													</script>
										<?php
											...
											<div class="sponsor_title">
												<a href="<?php if(!empty($featuredProduct['link'])){ echo $featuredProduct['link'];}else{ echo 'javascript:void(0);' ;} ?>"><?php echo $featuredProduct['title']; ?></a>
											</div>										
										</div>
										<style type="text/css">
											.jwplayer
