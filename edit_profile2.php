...
{
	$Obj->Redirect('edit_profile2.php?msg=success');die;
}
...
/***********/
	...
	if(!empty($_POST['pname']) && $_POST['pname'] != $_SESSION['profile_name'])
	{
		...
		if($countres > 0)
		{
			...
			$Obj->Redirect("edit_profile2.php?msg=success1"); die;
}
...
<div class="v2_container">
	...
	<form name="update_user" id="signup_1" method="post" enctype="multipart/form-data" class="user-edit-form">
     <div class="block_Divider">
			<div class="edit_profile_f">
 				...
 				<ul>
					...
					<!-- <li>
						...
						(Allowed exit's gif, png, jpg & jpeg)
					</li> -->
					<!-- profile image here  -->
		           <?php 
						$host_query = mysql_query("SELECT image_nm FROM user WHERE id = '".$_SESSION['user_id']."'");
		           ...
		           ?>
		           <a id="profileSeen" href="javascript:;"><img src="<?php echo $SiteURL.$displayImage; ?>"></a>
		           <!-- profile image  -->
			</ul>
              										
                    
        <div class="clear"></div>
         <div class='itemProfile'>Contact Information</div>
          <div class="item-data">
			<ul>
				<li>Profile Name: </li>
				<li>
			...
			<ul>
				<li>State: </li>
				<?php	$statesql=@mysql_query("select name,zone_id from zone where country_id ='".$country."'"); ?>
				<li>
	            	<div class='styled-select'>
		...
		<div class="clear"></div>
		<div class='itemProfile'>Settings</div>
		<div class="item-data">
	...
	<div id="profile_box">
		...
		<ul class="lField">
			<li><input name="clubname" type="text" id="name_club" onchange="return RestrictSpaceSpecial(this.value);" value="<?php echo ucfirst($club_name); ?>" />
			</li>
			<li class="imgLI">
				<!-- <div class="rFields">
	            <ul class="rField">
       ...
       <div class="block_Divider"> 
		    ...
		    <div class='firstTab itemProfile'>Contact Information</div>
		    <div class="item-data">
				...
				<div class="col-sm-4 userInfo">
					<ul>
						<li>
							...
							<textarea rows="5" required="" name="google_map_url" >
							<?php 
							if($google_map_url == "")
							{
		    ...
		    <div class='itemProfile'>Genre</div>
	    	<div class='item-data'>
		    ...
		    <div class='itemProfile'>Social Networks</div>
		    <div class='item-data'>
			    <div class="col-sm-6 userInfo">
				    <ul>
				      	<li>
							<label>Host Website Url:</label>
							<input type="text" name="web_url" id="web_url" value="<?php echo $web_url; ?>"  />
						
							<label>Host Facebook Url:</label>
							...
							<label>Host Instagram Url:</label>
	...
	if(isset($_POST['update_club2']))
	{
		...
		if($_FILES["profile_image"]["name"]!="")
		{
			...
			&& in_array($extension, $allowedExts))
		  {
			...
			//$update_sql="update clubs SET image_nm='".$forum_img."' where id='".$_SESSION['user_id']."'";

			@mysql_query("UPDATE `clubs` SET `image_nm` = '$forum_img' WHERE `id` =".$_SESSION['user_id']);
			  //session_start(); $_SESSION['img'] = $forum_img; session_write_close();
...
<!-- 			<input type="file" style="color: #fff; width:100%;padding: 44px 0px 44px 4px;border: 1px dashed #cccccc;" name="forum_hodtdj_profile_images[]" class="txt_box" id="add_post_videoahd" multiple onchange="return ValidateVideoUploadahd()" required /> -->
			...
			<input type="file" name="profile_image" id="selectedFile" style="color: #fff; width:100%;padding: 44px 0px 44px 4px;border: 1px dashed #cccccc;" onchange="return ValidateFileUpload()" required="" />
        	<input type="button" id="cancel_button" value="X">
        	<input type="submit" name="update_club2" value="Upload Image" class="button addfrmbutton"  />
        </div>
        </form>
