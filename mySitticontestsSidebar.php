...
.v2_timer_contest_right h2
{
	width: 96%;
	text-align: center !important;
}
.v2_registion_container > p
{
	color: #FFF;
}
</style>
<div id="liveContest_sidebar">
  	<div class="aside">
  		<div id="CountDownTimer">
			...
			<div class="clear"></div>
			<div class="v2_timer_contest_container main-example" <?php echo $class; ?>> 
		...
		<div class="clear"></div>
		<div class="v2_contest_block_panel v2_live_contest_block" style="display:none;">
		  	<h1>Live Battle</h1>
	  		<div class="v2_contest_block_panel_inner">
				<ul>
