...
<div data-aos="zoom-in-right" class="banner-section hotel-hero comedy-sec" style="background-image:url(images/local-hero.png)"> 
	<div class="container">
		<div class="mobile-hero">
			<img src="images/local-hero.png">
		</div>
		<div class="carousel-caption-top">
		   <h1>Concerts in  <?php echo $_SESSION['city_name']; ?></h1>
		</div>
                  ...
                  <div class="modal-body">
                    <div class="listing-check">
								...
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck01" value="all%20genre">
								  <label class="custom-control-label" for="customCheck01">All Genre</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck02" value="alternative">
								  <label class="custom-control-label" for="customCheck02">Alternative</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck03" value="ballads/romantic">
								  <label class="custom-control-label" for="customCheck03">Ballads/Romantic</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck04" value="blues">
								  <label class="custom-control-label" for="customCheck04">Blues</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck05" value="chanson%20francaise">
								  <label class="custom-control-label" for="customCheck05">Chanson Francaise</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck06" value="children%20music">
								  <label class="custom-control-label" for="customCheck06">Children's Music</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck07" value="classical">
								  <label class="custom-control-label" for="customCheck07">Classical</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck08" value="country" checked="">
								  <label class="custom-control-label" for="customCheck08">Country</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck09" value="dance/electronic">
								  <label class="custom-control-label" for="customCheck09">Dance/Electronic</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck10" value="folk">
								  <label class="custom-control-label" for="customCheck10">Folk</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck11" value="hip-hop/rap">
								  <label class="custom-control-label" for="customCheck11">Hip-Hop/Rap</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="holiday">
								  <label class="custom-control-label" for="customCheck12">Holiday</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="jazz">
								  <label class="custom-control-label" for="customCheck08">Jazz</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="latin">
								  <label class="custom-control-label" for="customCheck09">Latin</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="metal">
								  <label class="custom-control-label" for="customCheck10">Metal</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="new%20age">
								  <label class="custom-control-label" for="customCheck11">New Age</label>
								</div>
								<div class="custom-control custom-checkbox">
								  <input type="checkbox" class="custom-control-input activity" name ="dropDownId" id="customCheck12" value="other">
							...
							<div class="col-lg-12 col-12">
								<section class="client-sec comedy">
									<div class="testimonial-section products">
									   ...
									   $get_deals = groupon_api_call('20','','classical');
										if(!empty($get_deals)){ ?>
									...
									<div class="testimonial-section products">
									   ...
									   <?php $getyelpTourData = yelp_api_call(20,$_SESSION['city_name'],'More Concerts'); 
									...
									<div class='pagination'>
										<!-- <button class='pagination_btn prev-refine prev' field='quantity'>Previous</button> -->
										
										<input type='text' value="country" class='drop-value' style='display:none;'>	
