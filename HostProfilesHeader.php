...

{
	...
	$facebookLink = $loggedin_host_data['facebookLink'];

	$instaLink = $loggedin_host_data['instaLink'];

	$twitterLink = $loggedin_host_data['twitterLink'];
	...
	$hideaddress =  $loggedin_host_data['hideaddress']; 
...

{
	...
	$facebookLink = $get_host_data['facebookLink'];

	$instaLink = $get_host_data['instaLink'];

	$twitterLink = $get_host_data['twitterLink'];
	...
	$show_city_state_phone =  $get_host_data['show_city_state_phone']; 

	$hide_google_map =  $get_host_data['hide_google_map']; 

	$hideaddress =  $get_host_data['hideaddress']; 
...
<link rel="stylesheet" href="<?php echo $CloudURL;?>autocomplete/jquery.ajaxcomplete.css" />
  ...
  <?php 
	...
	if($_SERVER['SCRIPT_NAME'] == '/LiveContest.php' || $_SERVER['SCRIPT_NAME'] == '/bookingsTypeDetails.php' || $_SERVER['SCRIPT_NAME'] == '/NewLiveContest.php' || $_SERVER['SCRIPT_NAME'] == '/mysitti_contest.php')
...
<div class="v2_banner_top h_auto spacer2">
  ...
  <div class="v2_header_wrapper v2_pos_rel">
	...
	?>
						...
						<?php 	}
							...
							?>
							<li>
								<a href="<?php echo $SiteURL; ?>AllSocial.php">
									<span data-title="Social Page">Social Page</span>
								</a>
							</li>
						</ul>
						<div class="v2_profile_user profilrForDesktop">
							...
							else
							{
								...
								<div class="v2_profile_user_info user_info_host2"> <span class="v2_welcome_user">Welcome</span>
										...
										<?php if(empty($profilename)){ echo "Mysitti"; }else{ echo $profilename; } ?>
										</a> </span> 
								</div>
						</div>
 ...
 <?php 
	  ...
	  ?>		<div class="pullRight"  style="margin-left:15px;">
				...
				<div class="v2_profile_user nospace">
					...
					<div class="v2_profile_user_info"> 
						...
						<span class="welcome_user_logged_in">Welcome</span> <span class="user_logged_in"><a href="<?php echo $SiteURL;?>profile.php"><?php if(!empty($_SESSION['profilename'])){ echo $_SESSION['profilename'];}else{ echo $_SESSION['username'];} ?></a> </span> 
   ...
   <?php 	}	?>
	  ...
	  ?>		<div class="pullRight " style="margin-left:15px; display:none;" >
				...
				<div class="v2_profile_user nospace">
					...
					<div class="v2_profile_user_info"> 
						...
						<span class="welcome_user_logged_in">Welcome</span> <span class="user_logged_in"><a href="<?php echo $SiteURL;?>home_club.php"><?php if(!empty($_SESSION['profilename'])){ echo $_SESSION['profilename'];}else{ echo $_SESSION['username'];} ?></a> </span> 
   ...
   <div class="searchBoxTop h2h-view" style="right:0">
...
include("user_upgrade.php");
	...
	?>
		...
		<div class="uload_banner_header" style="display:none;"> <a href="upload-banner.php"><img src="images/uploadbanner.png" alt="Upload" title="Upload Header Banner"></a> </div>
		  ...
		  <div class="v2_profile2_right">
			...
			<div class="v2_alocation_pro2"> 
				...
				<?php 
					...
					if(!empty($club_address) && $hideaddress == '0' )

					{

						if($show_city_state_phone == '1')

						{
							...
							echo $fetchClubCity['city_name'].", ".$fetchClubState['name']." <br /> ".$phone;
   			...
   			?>
    				...
    				<img alt="" src="https://mysitti.com/images/fbook.png" al="">
				...
				<a href="<?php echo $twitterLink;?>">
					...
					<img alt="" src="https://mysitti.com/images/twt.png">
