...
.moreslide.collapsed::after {
  background: rgba(0, 0, 0, 0) url("../images/explorer.png") no-repeat scroll 0 center;
  content: " ";
  float: left;
  font-size: 18px;
  font-weight: bold;
...
.moreslide.expanded::after {
  background: rgba(0, 0, 0, 0) url("../images/expender.png") no-repeat scroll 0 center;
  content: "";
  float: left;
  font-size: 22px;
  font-weight: bold;
...
$(document).ready(function(){
	$('.contestDesc').readmore({
		lessLink: '<a href="#" class="moreslide expanded">Read less</a>',
		moreLink: '<a href="#" class="moreslide collapsed">Read more</a>',
		speed: 75,
			...
			if($contest_type != 'live')
			{
		 		...
		 		if(isset($_SESSION['user_id'])) 
	 			{
				  if($_SESSION['user_type'] == 'user'){ ?>
					...
					<a href="javascript:void(0);" onclick="window.location='contestForm.php?id=<?php echo $contest_id; ?>'">
				...
				{
			?>
					<a href="javascript:void(0);" onclick="open_redirect_loginpopup_event('<?php echo $SiteURL;?>contestForm.php?id=<?php echo $contest_id; ?>');">
						<img src="images/btn_enter_here.png" alt="" />
					</a>
			<?php	}			  
...
<div class="v2_contest_post_container newruls">
				...
				<div class="v2_contest_content_post">
					...
					<div class="v2_post_left_contest full_post_contest listing_city_contest">
                      ...
                      <div class="trcount"><?php echo $i_count; ?></div>
			  							...
			  							?>		
			  									...
			  									<a href="<?php echo $fetchuservideo['video_name'];?>" rel="lightbox">
											  		<img class="fancybox" rel="group" src="<?php if($fetchuservideo['video_thumb'] != "") { echo $fetchuservideo['video_thumb']; }else{ echo 'images/man4.jpg';} ?>" />
											  	</a>
										<?php 	}
			  								else
			  								{
