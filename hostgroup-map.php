...
$type_of_club=$_GET['add'];
 $sql = mysql_query("select * from `clubs` where `type_of_club` = '".$type_of_club."' AND  club_city='".$_SESSION['id']."' "); 
 $sql2 = mysql_query("select * from `clubs` where `type_of_club` = '".$type_of_club."' AND club_city='".$_SESSION['id']."' "); 
