...
<div class="v2_content_wrapper">
	<div class="v2_content_inner_topslider spacer1">
				...
				<div class="hotel-side">
				    ...
				    <div class="filter_ticketCity filter-group-deals">
					 ...
					 <div data-role="page">
						...
						<div class="cj_banner cj-baner-destop" style="margin-top: 20px; text-align: center;">
							...
							setTimeout(function(){ var geodemo = $('#target').val(); 
					      	if(geodemo.length > 0){
					           ...
					           alert("Please fill any city.");
								...
								$.ajax({
								    url: "groupon-cityguide-Filter.php",
								    type: "POST",
		...
		$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".rawurlencode($dropdown_city)."&lat=".$latitude."&lng=".$longitude."&division=".rawurlencode($dropdown_city)."&query=".rawurlencode($dropdown_city)."+events+deal&offset=0&limit=50&locale=en_US";
			...
			<div class="cj_banner cj-baner-mobile" style="margin-top: 20px; text-align: center;">
				<iframe src='//www.groupon.com/content-assembly/render/17296f80-92ef-11e7-90c4-0983c720d394' width='160' height ='600' frameBorder='0' scrolling='no'></iframe>
			</div>
		</div>
	</div>
