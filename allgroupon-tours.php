...
<div class="v2_content_wrapper">
	<div class="v2_content_inner_topslider spacer1">
		...
		<div class="headingActivity" style="margin-bottom: 20px;">
			...
			$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".rawurlencode($dropdown_city)."&lat=".$latitude."&lng=".$longitude."&query=".rawurlencode($dropdown_city)."+tours&offset=0&limit=50";
