...
<div id="v2_wrapper"> 
	...
	<div class="v2_header_wrapper">
		...
		if($countBanner != 0) { ?>
			...
			<?php } ?>
			<div class="uload_banner_header2" style="display:none;"> <a href="upload-banner.php"><img src="images/uploadbanner.png" alt="Upload" title="Upload Header Banner"></a> </div>
			<?php } ?>
		...
		<div class="clear"></div>
		<div class="v2_search_area" id="search_Events" <?php echo $hideSearch;?>>
