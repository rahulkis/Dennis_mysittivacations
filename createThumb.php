<?php
/*
0 	Resize to Fit specified dimensions (no cropping) zc =0
http://www.binarymoon.co.uk/demo/timthumb-zoom-crop/
http://localhost/mbvintagecars/inventory_images/timthumb.php?src=http://localhost/mbvintagecars/inventory_images/images_1379587548.jpg&w=500&h=30&zc=0
http://localhost/A-php-data/timthumb.php?src=apache_pb.png&w=500&h=32&zc=0
*/
/**
...
ini_set ( 'max_execution_time', 1200); 																	// Version of this script 
...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 20000000);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
