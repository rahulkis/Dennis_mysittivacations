...
$dropCity = $_POST['formatted'];
    ...
    $ch = curl_init();   
	$urlgo = "https://api.yelp.com/v3/businesses/search?term=winery+and+brewery&latitude=".$latitude."&longitude=".$longitude."";
     ...
     foreach ($getyelpTourData as $homeData)
	    ...
	    $tour_category3 = @$homeData->categories[2]->title;
	     ...
	     $html .= "<div class='row tab-two'>
					...
					$html .= "<img src='".$SiteURL."images/noimage-found.jpeg'>";
					 }
					$html .= "</a></div>
					</div>
