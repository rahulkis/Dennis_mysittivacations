...
<div class="v2_content_wrapper">
	...
	$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".rawurlencode($dropdown_city)."&lat=".$latitude."&lng=".$longitude."&query=".rawurlencode($dropdown_city)."+winery+and+brewer&offset=0&limit=50";
