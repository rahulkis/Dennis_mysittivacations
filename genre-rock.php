...
<div data-aos="zoom-in-right" class="banner-section hotel-hero comedy-sec aos-init aos-animate" style="background-image:url(images/Rock.jpg)">
    <div class="container">
                    ...
                    <div class="modal fade" id="filter-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input activity" id="customCheck05" name ="dropDownId" value="rock%20music" checked="">
                                  <label class="custom-control-label" for="customCheck05">Rock Music</label>
                                </div>
                                <div class="custom-control custom-checkbox">
                            ...
                            <section class="client-sec comedy">
                                <div class="testimonial-section products">
                                    <div class="owl-carousel owl-theme" id="ProductSlide-audio">
                                        ...
                                        <?php function groupon_api_call($limit,$city,$key){
										   ...
										   $get_deals = groupon_api_call('20','','rock-pop');
											if(!empty($get_deals)){ ?>
                                ...
                                <div class="testimonial-section products">
                                    ...
                                    <div class="owl-carousel owl-theme" id="ProductSlide-audio2">
                                        <?php $getyelpTourData = yelp_api_call(20,$_SESSION['city_name'],'Alternative Rock'); 
    ...
    var app = new Vue({
        ...
        methods: {
            getGenreData: function() {
                var vm = this;
                vm.ajaxRequest = true;
                vm.checkSessionServer = axios.post('ajax_specific_genre.php', {
    ...
    $(".selectRangeteam").click(function() {
        ...
        if (drop_down_keyword == '' || drop_down_keyword == undefined) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {
                    formatted: textBox_city,
                    srartdate: date1,
                    enddate: date2,
                    doropdown: drop_down_keyword
                },
                beforeSend: function() {
                    $("#loader").addClass("loading");
                },
...
<style>
    ...
    @media screen and (max-width:767px) {
        ...
        .resturant_listhead .sorf-filter a {
            display: none;
        }
            ...
            for (var i = 1; i <= 20; i++) {
                ...
                if (pics_str != undefined) {
                    ...
                    jQuery.each(pics_arr, function(index, el) {
                        ...
                        jQuery('.section_' + i + ' .cui-svg-placeholder').css({
