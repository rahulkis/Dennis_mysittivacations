	...
	<div class="v2_content_inner_topslider spacer1">
		...
		<div class="headingActivity" style="margin-bottom: 20px;">
			...
			<?php
				...
				$urlgo = "https://partner-api.groupon.com/deals.json?tsToken=US_AFF_0_207698_212556_0&division_id=".$dropdown_city."&query=".$dropdown_city."+kids+activities+and+attactions&offset=0&limit=50";
