...
function groupon_api_call($limit,$city,$key){
	...
	return $get_deals;
		...
		$get_deals = groupon_api_call('40',$_POST['formatted'],$_POST['key']);
...
?>
			<div class="headingActivity-new1 groupon_deals_common_class container">
						<h2> Groupon Restaurants Deals </h2>
			</div>
			<?php if(!$detect->isMobile()) { ?>
			 <div class="owl-carousel owl-theme">
				...
				?>	
						<div class="item col-sm-12 col-xs-12 city-recom" style="float: left; list-style: none; position: relative; width: 290px;">
							<div class='borderIsan hotelandingDeal' style="width: 270px;">
