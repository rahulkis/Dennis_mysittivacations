...
<!--<section class="inner_page_hero sec_pad comedy_sec_bg">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="hero_section_content">
					<h2 class="mb-5">Laugh With US!</h2>
				</div>
			</div>
			<div class="col-lg-12">
...
<div data-aos="zoom-in-right" class="banner-section hotel-hero comedy-sec" style="background-image:url(images/comedy-hero.png)"> 
	<div class="container">
					...
					<div class="sidebar-listing">
						...
						<div class="mobile-filter">
							<ul>
								...
								<li>
										<a href="javascript:void(0)" class=""  style="cursor:pointer;" data-toggle="modal" data-target="#myModal-cuisine"><i class="fa fa-filter" aria-hidden="true"></i>Filter</a> 
								</li>
							</ul>
						</div>
						<div class="modal fade" id="myModal-cuisine" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Category</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span class="finalClose" aria-hidden="true">&times;</span>
										</button>
									</div>
							...
							<div class="col-lg-12 col-12">
								<section class="client-sec comedy">
									<div class="testimonial-section products">
									   ...
									   <?php
									   $get_deals = groupon_api_call('20','','comedy-clubs');
									   if(!empty($get_deals)){ ?>
									...
									<div class="testimonial-section products">
									   ...
									   <div class="owl-carousel owl-theme" id="ProductSlide-audio2">
											<?php
											$getyelpTourData = yelp_api_call(20,$_SESSION['city_name'],'Comedy');
									  ...
									  <div class="accordion-item">
										...
										<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
										  <div class="accordion-body">
											<script src="https://www.travelpayouts.com/blissey/scripts_en.js?currency=usd&categories=center&id=<?php echo $city_data; ?>&type=compact&marker=130544&trs=26480&powered_by=true&host=search.hotellook.com&locale=en&limit=10&nobooking=" charset="utf-8"></script>
										  </div>
										</div>
									  </div>
									  <div class="accordion-item">
										...
										<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
										  <div class="accordion-body">
											<script src="https://www.travelpayouts.com/blissey/scripts_en.js?currency=usd&categories=pets&id=<?php echo $city_data; ?>&type=compact&marker=130544&trs=26480&powered_by=true&host=search.hotellook.com&locale=en&limit=10&nobooking=" charset="utf-8"></script>
										  </div>
										</div>
									  </div>
									  <div class="accordion-item">
										...
										<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
										  <div class="accordion-body">
											<script src="https://www.travelpayouts.com/blissey/scripts_en.js?currency=usd&categories=luxury&id=<?php echo $city_data; ?>&type=compact&marker=130544&trs=26480&powered_by=true&host=search.hotellook.com&locale=en&limit=10&nobooking=" charset="utf-8"></script>
										  </div>
										</div>
									  </div>
									  <div class="accordion-item">
									   ...
									   <div class="accordion-item">
										...
										<div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="headingfive" data-bs-parent="#accordionExample">
										  <div class="accordion-body">
											<script src="https://www.travelpayouts.com/blissey/scripts_en.js?currency=usd&categories=5stars&id=<?php echo $city_data; ?>&type=compact&marker=130544&trs=26480&powered_by=true&host=search.hotellook.com&locale=en&limit=10&nobooking=" charset="utf-8"></script>
										  </div>
										</div>
									  </div>
								</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document.body).on('click','.next-refine',function(e){
			...
			$.ajax({
				url: "ajax_refine_ticketmaster_next_data-dev.php",
				type: "POST",
				data: {
...
<script type="text/javascript">
	...
	$(document).on('click','.activity',function(){
		   $('#myModal-cuisine').modal({ show: true})
		 // $('.modal-open').hide();
		var textBox_city = $('#refine-result').val();
		var date1 = $('#dpd_team').val();
		var date2 = $('#dpdtm').val();
		var drop_down_keyword = $("input[name='dropDownId']:checked").val();
		$.ajax({
			url: "ajax_refine_ticketmaster_data-dev.php",
			type: "POST",
			data: {
				formatted: textBox_city, srartdate: date1, enddate : date2, doropdown : drop_down_keyword
			},
...
<style>
	...
	@media screen and (max-width:767px){
		...
		.mobile-filter ul li a {font-size: 16px;width: 100%;}
		.mobile-filter ul li a i {margin: 0 10px 0 0px;}
		.mobile-filter {border-top: 1px solid #ccc;padding: 0px 0 0px;border-bottom: 0px solid #ccc;margin: 0 0 0px;}
		...
		.mobile-filter ul {margin: 0;padding: 0;}
