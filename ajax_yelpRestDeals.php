...
?>
		<div class="horizontal-yelp-topbanner text-muted">
			...
			if($data['formatted'] == 'Washington'){
				$formattedA = 'Washington D.C.';
			}else{
				$formattedA = $data['formatted'];
			}
			$getyelpTourData = yelp_api_call($limit,$formattedA,$data['key']);      
	...
	<?php
			endforeach;?>
			<div class="load_more_yelps" style="text-align: center;color: black;" data-key="" data-id="<?php echo $limit; ?>">Load more<div>
			<?php
		else:
	?>
