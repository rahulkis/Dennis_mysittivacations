...
<div class="seprators"></div>
			<div class="comedy_listing_box">
				<div class="event_icon_comedy"> 
					<img src="images/special_comedy_icon.png" align=""> 
				</div>
				<div class="events_listing_comedy">
					<div class="special_comedy">
			 			<h1 class="h1">Specials</h1>
			 		<?php 
					...
					?>
						<div class="special_comdy">
							...
							<?php
								...
								{
									echo '<ul><li><img src="images/availableSoon.png" align=""></li></ul>';
								}
							?>
						</div>
						<?php 
						...
						?>
									<h5>
										<a target="_blank" href="<?php echo $specailsFetch['adv_link'];?>" target="_blank">
					...
					<div class="pass_comedy">
						<h1 class="h1">Passes</h1>
						<div class="photo_comedy_slider photo_slider">
							<script type="text/javascript">
								$(document).ready(function(){
									// $('.photoslider2').bxSlider({
									// 	minSlides: 1,
									// 	//maxSlides: 2,
									// 	slideMargin: 10,
									// 	slideWidth: 230,
...
<span class="redeemedpass">REDEEMED</span><div class="clear"></div><div class="clear"></div><h5><?php echo $rowCoupon['coupon_name'];?></h5>
  ...
  <div class="seprators"></div>
				...
				<div class="comedy_listing_box _photos_comedy">
					<div class="event_icon_comedy"> 
						<img src="images/photo_comedy_icon.png" align=""> 
					</div>
					<div class="events_listing_comedy photo_com">
						<h1 class="h1">Photos</h1>
						<div class="comedy_slider_photo photo_slider">
  ...
  <div class="seprators"></div>
				<!-- video section comedy -->
				<div class="comedy_listing_box band_video">
					<div class="event_icon_comedy"> 
						<img src="images/video_comedy_icon.png" align="">
					</div>
					<div class="events_listing_comedy video_com">
