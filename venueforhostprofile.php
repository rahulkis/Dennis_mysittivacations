					...
					<div id="calendar">
						...
						<div style="float: left; margin: 10px 0;">
						  	See all list of <a style="font-style: italic; color: rgb(254, 205, 7);" href="listvenue.php?host_id=<?php echo $hid; ?>">Upcoming Events</a>
					  	</div>							
						<!-- VENUE CALENDAR -->
								...
								$v=0;
                                                    foreach($new_eventsx  as $keysx=>$valuex ){
														...
														if($valuex['date']==$event['date'] && $v<2){
															...
															$calendar.= "<a class='tooltip' href='read_venue.php?host_id=".$_GET['host_id']."&id=".$valuex['id']."'>".$stringlocation."</br>
...
$bookings = array();
 ...
 $query = "SELECT id ,location, date FROM venues WHERE month(date) = '$month' AND year(date) = '$year' AND host_id='$hostID'";
